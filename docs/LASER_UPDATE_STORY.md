...
| 12 | 高维维护质量缺口(GIST960 −2.3~−3.3pp):**前沿已扫**(§20:ins400 +0.72pp/−35% 吞吐、garden 高维零效、ins600 探顶仍差 −1.38pp=剂量枯竭)⇒ **归因已定(§22):侵蚀非复利**(fresh 桶≈静态零衰减,old−fresh −4.2pp,headroom 反证)——garden 修入度=错靶;E9 破坏者隔离(exact-evict/no-splice/滞回)在跑,修复方向=老边保护/victim-directed repair | A16 | 中(诊断 ~1h;修复未知) | **P0(高维是主场;论文口径=显式前沿曲线+归因,非单点配方)** |
