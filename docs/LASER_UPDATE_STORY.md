...
| 10 | 口径统一:≥3 seeds、recall@10/@100 双报、三组分层(插入点/老点/全体)、非 2 次幂维度数据集(**96d 已直通**——§17 闸门修复后全主维 pd128 质量腿 0.9883@ef100,PCA 残差腿降级为对照;npp=2 多行页 P2 实证通过) | A12/A15 | 中(机时为主) | P1(随规模批次一起跑) |
