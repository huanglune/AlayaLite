...
| 12 | 高维维护质量缺口(GIST960 −2.3~−3.3pp):**前沿已扫**(§20:ins400 +0.72pp/−35% 吞吐、garden 高维零效、ins600 探顶仍差 −1.38pp=剂量枯竭)⇒ 剩余 ~1.4-2pp 结构归因(E6 年龄分解:复利 vs 侵蚀 vs headroom)与响应设计 | A16 | 中(诊断 ~1h;修复未知) | **P0(高维是主场;论文口径=显式前沿曲线+归因,非单点配方)** |
