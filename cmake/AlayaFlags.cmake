...
# or -march=native with ALAYA_NATIVE_ARCH=ON) applies in every configuration: intrinsics headers refuse to compile
# without it. - -Ofast/-funroll-loops are Release-only. Debug builds now really are debuggable (this deliberately
# diverges from the pre-rewrite behavior, where -Ofast overrode -g/-O0 in every configuration). MSVC needs no explicit
# /O2: its Release configuration already carries it, and forcing it globally used to fight /Od+/RTC1 in Debug (D9025). -
# Sanitizer builds (detected in AlayaToolchain.cmake from -fsanitize in CMAKE_CXX_FLAGS) pin -O1 in all configurations
# so UBSan/ASan reports keep usable stacks without making the suite unbearably slow.
